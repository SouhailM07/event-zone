...
<body class=" bg-gray-200">
    @if(session("success"))
    <div id="toast-default"  class="fixed right-[4rem] top-[4rem] drop-shadow-2xl  z-[40]  flex items-center w-full max-w-xs p-4 text-body bg-neutral-primary-soft rounded-base shadow-xs border border-default" role="alert">
        ...
        <div class="ms-2.5 text-sm border-s border-default ps-3.5">{{session("success")}}</div>
    ...
    <div id="toast-default"  class="fixed right-[4rem] top-[4rem] drop-shadow-2xl  z-[40]  flex items-center w-full max-w-xs p-4 text-body bg-neutral-primary-soft rounded-base shadow-xs border border-default" role="alert">
        ...
        <x-molecules.dev-error-panel :error="session('errorMsg')"/>
    @endif
        <x-organisms.navbar/>
